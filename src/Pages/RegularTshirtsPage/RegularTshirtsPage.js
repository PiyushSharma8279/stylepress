...
const products = [
  ...
  },
  {
    ...
    image:
      "https://stylepress.in/wp-content/uploads/2025/09/black-oversize-tshirt-with-musculer-male-model-bac-1.png",
    price: 399,
    oldPrice: 599,
  },
  {
    ...
    image:
      "https://stylepress.in/wp-content/uploads/2025/05/goku-stylepress-2.png",
    sale: true,
    price: 499,
    oldPrice: 699,
  },
  {
    ...
    image:
      "https://stylepress.in/wp-content/uploads/2025/04/god-of-war.png",
    price: 599,
    oldPrice: 799,
  },
  {
    ...
    image:
      "https://stylepress.in/wp-content/uploads/2025/04/white-oversize-tshirt-on-hanger-back-view.jpg",
    price: 449,
    oldPrice: 600,
  },
  {
    ...
    name: "Vintage Hoodie",
    image:
      "https://stylepress.in/wp-content/uploads/2025/03/black-oversize-tshirt-on-hanger-back-view.webp",
    sale: true,
     price: 699,
    oldPrice: 799,
  },
  {
    ...
    image:
      "https://stylepress.in/wp-content/uploads/2025/09/Gemini_Generated_Image_20s03z20s03z20s0-1.png",
    price: 699,
    oldPrice: 799,
  },
];
...
export default function RegularTshirtsPage() {
  ...
  return (
    ...
    <section className="py-20 bg-[#f8f8f8] text-center">
      {/* Section Title */}
      <h2 className="text-4xl md:text-5xl font-bold text-black">Regular Tshirts</h2>
