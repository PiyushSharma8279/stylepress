...
export default function Header() {
    ...
    return (
        <header className=" fixed top-0 right-0 left-0 z-50 flex justify-between items-center px-6 md:px-16 py-4 border-b border-gray-200 bg-white">
            {/* Logo */}
            ...
            {isOpen && (
                <div className="absolute top-16 left-0 w-full bg-white shadow-md flex flex-col items-center space-y-4 py-6 md:hidden z-50">
                    <a href="#" className="flex items-center space-x-1">
                        <span className="text-2xl">—</span> <span>home</span>
                    </a>
                    <a href="#">OverSized Tshirts</a>
                    <a href="#">Regular Tshirts</a>
                    <a href="#">Contact</a>
                    <a href="#">My Account</a>
                    <a href="#">Return Policy</a>
                </div>
